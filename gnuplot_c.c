...
#include "gnuplot_c.h"
    ...
    #endif
    #ifndef GPC_TERM
        #define GPC_TERM    "x11"                            // Gnuplot term type
    #endif
    #define mssleep(u) usleep(u*1000)
#endif
...
h_GPC_Plot *gpc_init_xy(const char *plotTitle, const char *xLabel, const char *yLabel, const enum gpcKeyMode keyMode,
...

{
    ...
    plotHandle->scalingMode = scalingMode;
    ...
    fprintf (plotHandle->pipe, "set xlabel \'%s\' offset 0.45,0.45\n", xLabel);
    fprintf (plotHandle->pipe, "set ylabel \'%s\' offset 0.55,-0.45 rotate by 0\n", yLabel);
    fprintf (plotHandle->pipe, "set key off\n");
